...
//	}
	...
	public void testUpdateProduktTC1() {
		try {
			Controller.updateProdukt(null, k1, "IPA", "Bedre end bedste", 1, 0);
			fail();
		} catch (IllegalArgumentException iae) {
	...
	public void testUpdateProduktTC2() {
		try {
			Controller.updateProdukt(p1, null, "IPA", "Bedre end bedste", 1, 0);
			fail();
		} catch (IllegalArgumentException iae) {
	...
	public void testUpdateProduktTC3() {
		Produkt actual = p1;
		Controller.updateProdukt(p1, k1, "IPA", "Bedre end bedste", 1, 0);
