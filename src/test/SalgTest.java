...
public class SalgTest {
	...
	private static Salg s0, s1, s2, s3, s4;
	private static Produkt p0, p1;
	private static ProduktKategori prodK;
	private static PrisKategori prisK;
	...
	public void testGetProduktLinjerTC1() {
		...
		pl0 = s0.opretProduktLinje(p0, prisK, 4, 0);
		pl1 = s0.opretProduktLinje(p1, prisK, 1, 0);
	...
	public void testOpretProduktLinjerTC1() {
		ProduktLinje expected = new ProduktLinje(p0, prisK, 2, 0);

		pl0 = s0.opretProduktLinje(p0, prisK, 2, 0);
	...
	public void testSletProduktLinjeTC1() {
		pl0 = s1.opretProduktLinje(p0, prisK, 2, 0);
	...
	public void testGetTotalPrisTC1() {
		...
		pl0 = s2.opretProduktLinje(p0, prisK, 1, 0);
		Controller.addPrisToProdukt(p0, prisK, 100);
	...
	public void testGetTotalPrisTC2() {
		pl0 = s1.opretProduktLinje(p0, prisK, 1, 0);
		pl1 = s1.opretProduktLinje(p1, prisK, 1, 0);
		Controller.addPrisToProdukt(p0, prisK, 100);
		Controller.addPrisToProdukt(p1, prisK, 120);
	...
	public void testGetTotalKlipPrisTC1() {
		...
		pl0 = s3.opretProduktLinje(p0, prisK, 1, 0);
	...
	public void testGetTotalKlipPrisTC2() {
		...
		pl0 = s4.opretProduktLinje(p0, prisK, 1, 0);
		pl1 = s4.opretProduktLinje(p1, prisK, 1, 0);
